...
$sender =   "+4915735861236"; // Mobile number with country code (but without + or 00)
$imei =     "354663/10/627725/"; // MAC Address for iOS IMEI for other platform (Android/etc)

$countrycode = substr($sender, 0, 2);
$phonenumber=substr($sender, 2);
php whatsapp.php -i 4915788867468
if ($argc < 2) {
